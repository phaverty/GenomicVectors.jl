...
@testset begin
    ...
    @test starts(intersect(x, y)) ==
          intersect(Int64[3e5, 1.8e5, 1.9e5, 1e4], Int64[2e5, 1.8e5, 1.8e5, 1e4])
    @test starts(setdiff(x, y)) ==
          setdiff(Int64[3e5, 1.8e5, 1.9e5, 1e4], Int64[2e5, 1.8e5, 1.8e5, 1e4])
    @test starts(symdiff(x, y)) ==
          symdiff(Int64[3e5, 1.8e5, 1.9e5, 1e4], Int64[2e5, 1.8e5, 1.8e5, 1e4])
    x = GenomicPositions(xpos, chrs, chrinfo)
    y = GenomicPositions(ypos, chrs, chrinfo)
    append!(x, y)
